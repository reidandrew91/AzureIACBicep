...
param vnetName string = 'testandrewreid1-vnet'
...
param applicationGatewayName string = 'testgateway1'
...
param containerGroupName string = 'testcontainer3'
param containerGroupName2 string = 'testcontainer4'

@description('Container name')
param containerName string = 'testcontainer3'
param containerName2 string = 'testcontainer4'
...
resource publicIP 'Microsoft.Network/publicIPAddresses@2020-06-01' = {
  ...
  properties: {
    ...
    dnsSettings: {
      domainNameLabel: 'testandrewreidcontainer34'
      fqdn: 'testandrewreidcontainer34'
    }
  }
}
