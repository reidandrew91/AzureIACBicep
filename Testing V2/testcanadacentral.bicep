...
param vnetName string = 'testandrewreid-vnet'

@description('Virtual Network address range')
param vnetAddressPrefix string = '10.0.0.0/16'
param vnetAddressPrefix1 string = '10.1.0.0/16'

@description('Name of the subnet')
param subnetName string = 'default'
param subnetName1 string = 'default1'

@description('Subnet address range')
param subnetAddressPrefix string = '10.0.0.0/24'
param subnetAddressPrefix1 string = '10.1.0.0/24'

@description('Application Gateway name')
param applicationGatewayName string = 'testgateway'
...
param containerGroupName string = 'testcontainer1'
param containerGroupName2 string = 'testcontainer2'

@description('Container name')
param containerName string = 'testcontainer1'
param containerName2 string = 'testcontainer2'
...
resource publicIP 'Microsoft.Network/publicIPAddresses@2020-06-01' = {
  ...
  properties: {
    ...
    dnsSettings: {
      domainNameLabel: 'testandrewreidcontainer12'
      fqdn: 'testandrewreidcontainer12'
    }
  }
}
